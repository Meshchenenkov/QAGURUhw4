...
def test_greeting():
    ...
    output = ("Привет, {a}! Тебе {b} лет.".format(a=name, b=age)) #специально попробовал так
    print(output)
    # Проверяем результат
...
def test_unique_elements():
    ...
    l = list(set(l)) #приводим список l к множеству удаляя повторяющиеся элементы, потом приводим к списку
